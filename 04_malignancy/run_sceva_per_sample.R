...
# SCEVAN analysis for a single 10x Genomics sample
#
# Purpose
# -------
# Run the SCEVAN CNA pipeline on a single 10x Genomics expression matrix
# and save the resulting SCEVAN classification output.
#
# Usage
# -----
...
# Arguments
# ---------
# sample_matrix : Directory containing the 10x Genomics matrix files.
# sample_name   : Sample identifier passed to SCEVAN and used in output files.
# output_dir    : Directory in which SCEVAN results will be written.
# cores         : Optional number of CPU cores (default: 15).
#
# Reproducibility
# ---------------
# Package versions should be managed at the repository level, for example
# with renv and an accompanying renv.lock file. No machine-specific library
# paths are defined in this script.
